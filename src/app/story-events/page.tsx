      ...
      <div className="mx-auto max-w-7xl">
        <nav className="flex items-center justify-between rounded-full border border-slate-200/80 bg-white/80 px-3 py-2 shadow-[0_10px_24px_rgba(15,23,42,0.04)] backdrop-blur-sm">
          ...
          <div className="flex items-center gap-2">
            ...
            <Link href="/story-events" className="rounded-full bg-slate-900 px-3 py-1.5 text-xs font-medium text-white shadow-[0_8px_18px_rgba(15,23,42,0.12)] ring-1 ring-slate-900/10" style={{ color: "#ffffff" }}>타임라인</Link>
