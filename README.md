...
- 배포 환경에서는 GitHub에 저장 버튼으로 JSON 시드 파일 동기화 가능
...
배포된 웹에서 저장 내용을 GitHub 저장소의 JSON 파일에 반영하려면 Vercel 프로젝트에 아래 환경변수를 설정해야 합니다.
...
GITHUB_TOKEN은 해당 저장소의 contents 쓰기 권한이 있는 GitHub 토큰이어야 합니다.
